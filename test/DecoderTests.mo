...
module {
    ...
    public func run() {
        ...
        test([0xbf, 0x63, 0x46, 0x75, 0x6e, 0xf5, 0x63, 0x41, 0x6d, 0x74, 0x21, 0xff], #majorType5([(#majorType3("Fun"), #majorType7(#bool(true))), (#majorType3("Amt"), #majorType1(-2))]), ?[0xA2, 0x63, 0x46, 0x75, 0x6E, 0x63, 0x41, 0x6D, 0x74, 0x21]);
        ...
        test([0xc1, 0xfb, 0x41, 0xd4, 0x52, 0xd9, 0xec, 0x20, 0x00, 0x00], #majorType6({tag=1; value=#majorType7(#float(#f64(FloatX.floatToFloat64(1363896240.5))))}), null);
